...
const Footer = () => {
  return (
    <footer className="bg-[#0d315c] text-white py-10 px-6 text-sm">
      <div className="max-w-7xl mx-auto flex flex-wrap gap-8 justify-between text-center md:text-left">
        {/* About */}
        <div className="flex-1 min-w-[200px]">
          <h3 className="text-2xl font-bold text-[#ffaf3a]">SMRU</h3>
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-4">
            {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map(
              (Icon, i) => (
                <Icon
                  key={i}
                  className="text-xl cursor-pointer hover:text-[#019e6e] transition"
                />
              )
            )}
          </div>
        ...
        {/* Quick Links */}
        <div className="flex-1 min-w-[200px]">
          <h4 className="text-xl font-bold text-[#ffaf3a] mb-4">Quick Links</h4>
          <ul className="space-y-2">
            <li>
              <Link
                to="/"
                className="text-white/80 hover:text-[#019e6e] transition"
              >
                Home
              </Link>
            </li>
        ...
        {/* Programs */}
        <div className="flex-1 min-w-[200px]">
          <h4 className="text-xl font-bold text-[#ffaf3a] mb-4">Programs</h4>
          <ul className="space-y-2">
            {[
        ...
        {/* Contact */}
        <div className="flex-1 min-w-[200px]">
          <h4 className="text-xl font-bold text-[#ffaf3a] mb-4">Contact Info</h4>
