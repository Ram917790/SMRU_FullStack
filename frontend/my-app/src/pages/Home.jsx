// Home.jsx — UI-only refinements: small focus/contrast tweaks; no logic changes.
        ...
        return (
          ...
          >
            ...
            >
              ...
              <span className="text-warning text-2xl font-bold leading-none">
                {isOpen ? "−" : "+"}
              </span>
            </button>
            {isOpen && (
    ...
    <>
        ...
        <div className="absolute left-6 sm:left-8 md:left-12 top-[14vh] sm:top-[12vh] md:top-[10vh] z-10">
          <div className="max-w-[46rem]">
            <div className="flex items-start gap-3">
              ...
              />
              <h1
                className="text-white font-extrabold tracking-tight drop-shadow-[0_3px_12px_rgba(0,0,0,0.45)] text-[8vw] sm:text-[6.5vw] md:text-6xl lg:text-[64px] leading-none flex flex-col items-start gap-1 sm:gap-1.5 md:gap-2"
                aria-label="St. Mary's Rehabilitation University - SMRU"
              >
                <span className="block" data-reveal="fade-up" style={{ "--delay": "0.00s" }}>St.Mary's</span>
                <span className="block" data-reveal="fade-up" style={{ "--delay": "0.08s" }}>Rehabilitation</span>
                <span className="block" data-reveal="fade-up" style={{ "--delay": "0.16s" }}>University</span>
                <span className="block text-warning tracking-wider" data-reveal="fade-up" style={{ "--delay": "0.24s" }}>SMRU</span>
              </h1>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mx-auto mt-2 h-1.5 w-20 rounded-full bg-warning" data-reveal="fade-up" style={{ "--delay": "0.05s" }} />
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {campusItems.map((item, i) => (
              <article
                ...
                style={{ "--delay": `${0.08 + i * 0.06}s` }}
              >
                <div className="h-20 w-20 rounded-2xl bg-warning/15 text-warning grid place-items-center text-4xl mb-4">
                  {item.icon}
                </div>
      ...
      <section id="hostels" className="py-16 bg-[#f5f9ff]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <div
              className="mx-auto mt-2 h-1.5 w-20 rounded-full bg-warning"
              data-reveal="fade-up"
              style={{ "--delay": "0.05s" }}
            />
            <p
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mx-auto mt-2 h-1.5 w-20 rounded-full bg-warning" />
          <div className="mt-8">
            <Accordion faqs={faqs} />
          </div>
        </div>
      ...
      {/* ======================== CTA STRIP (navy) ======================== */}
      <section className="bg-warning py-16 text-center text-white">
